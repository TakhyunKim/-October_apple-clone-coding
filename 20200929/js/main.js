        ...
        switch (currentScene) {
            case 0:
                ...
                if (scrollRatio <= 0.22) {
                    ...
                    objs.messageA.style.transform = `translate3d(0, ${calcValues(values.messageA_translateY_in, currentYOffset)}%, 0)`; // translateY에서 3d로 바꾼 이유는 하드웨어 가속이 보장되어 퍼포먼스를 향상되는 효과를 볼수았음
                } else {
                    // out
